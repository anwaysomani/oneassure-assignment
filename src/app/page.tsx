...
export default function Home() {
  ...
  const [insuredSum, setInsuredSum] = useState(300000);
  ...
  // record data in local vars to calculate
  function recordData() {
    if(pageNum == 1) {
  ...
  return (
    <main className="flex">
      <div className="flex min-h-screen flex-col justify-between p-8 w-2/5">
                  ...
                  <li>
                      ...
                      <label htmlFor="tier-1" className="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">                           
                          <div className="block">
                              ...
                              <div className="w-full text-sm text-gray-500">Population &#8593;1L</div>
                          </div>
      ...
      <div className="flex min-h-screen flex-col justify-between pt-12 pb-12 pl-4 pr-4 w-3/5">
        ...
        {elements.map((elem) => (
            <div className="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="flex items-center justify-between mb-4">
                ...
                <p className="text-gray-500 dark:text-gray-400">age&nbsp;-&nbsp;<strong class="font-semibold text-gray-900 dark:text-white">{elem.age}</strong></p>
              </div>
