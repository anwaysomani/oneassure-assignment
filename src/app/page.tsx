  ...
  return (
    <main className="flex">
      ...
      {elements.length > 0 ?
        ...
        <a href="#" className="block max-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700 mb-4">
          <p className="font-normal text-gray-700 dark:text-gray-400">Amount</p>
          <hr className="h-px mt-2 mb-3 bg-gray-200 border-0 dark:bg-gray-700" />
          <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">&#8377;&nbsp;{finalAmount}/-</h5>
        </a>
